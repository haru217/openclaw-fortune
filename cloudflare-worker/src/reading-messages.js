...
export function buildReadingIntroCard(baseUrl) {
  const body = {
    ...
    contents: [
      ...
      { type: 'text', text: '料金 1,980円（税込）', color: COLOR_GOLD, size: 'md', weight: 'bold', margin: 'md' },
      { type: 'text', text: 'お届けまで 24時間以内', color: COLOR_LIGHT, size: 'sm' },
      { type: 'text', text: '※ご質問に回答後、お支払い方法をご案内します', color: COLOR_MUTED, size: 'xs', wrap: true, margin: 'sm' },
    ],
  };
