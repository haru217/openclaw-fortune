...
const TAROT_FILENAMES = [
  ...
  '08-strength.jpg','09-hermit.jpg','10-wheel.jpg','11-justice.jpg',
...
async function generateReadingPdf(request, opts = {}) {
  ...
  const cardFilename = TAROT_FILENAMES[tarotId];
...
`;
  ...
  const vars = {
    ...
    '{{tarot_meaning}}': (TAROT_MEANINGS[cardName] || {})[tarotReversed ? 'reversed' : 'upright'] || '',
